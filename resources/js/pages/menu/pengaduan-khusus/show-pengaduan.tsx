import DetailPengaduanKhusus from '@/components/detail-pengaduan-khusus';
...
import { BreadcrumbItem, Pengaduan, PengaduanKhusus, SharedData } from '@/types';
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex w-full gap-x-5 not-lg:flex-col not-lg:gap-y-3">
                    <div className="w-full max-w-4xl not-lg:order-2">
                        ...
                        <DetailPengaduanKhusus pengaduan={pengaduan} className="border-b pb-3" />
                    </div>
                    <div className="w-full space-y-5 lg:max-w-sm">
                        <Card className="shadow-none">
                            <CardHeader>
                                <CardTitle>Info Pengaduan Khusus</CardTitle>
                            </CardHeader>
                            <CardContent>
