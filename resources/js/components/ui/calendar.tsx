...
function Calendar({
  ...
  const fromYear = currentYear - 80; // Rentang tahun
  ...
  function CustomCaption({ displayMonth }: { displayMonth: Date }) {
    const { goToMonth } = useNavigation(); // ✅ Menggunakan useNavigation untuk mendapatkan goToMonth
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Caption: CustomCaption, // ✅ Menggunakan custom caption
      }}
      {...props}
    />
  );
