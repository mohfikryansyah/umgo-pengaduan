...
export default function ListPengaduanKhusus({ items }: { items: PengaduanKhusus[] }) {
                        ...
                        <Card key={item.id} className='mb-4'>
                            <CardContent>
                                ...
                                <div className="mt-6 border-b pb-4">
                                    ...
                                    <p className="mt-2 text-sm leading-6 text-gray-600">{limitText(item.kronologi, 300)}</p>
                                </div>
