...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('khusus/pengaduan-khusus', PengaduanKhususController::class)
        ...
        ->middlewareFor(['create', 'store'], 'role:mahasiswa')
        ->middlewareFor(['destroy', 'update'], 'role:admin');
    Route::put('pengaduan/update-validasi-rektor/{pengaduanKhusus}', [PengaduanKhususController::class, 'updateValidasi'])->name('pengaduan.update.validasi')->middleware('role:rektor');
});
